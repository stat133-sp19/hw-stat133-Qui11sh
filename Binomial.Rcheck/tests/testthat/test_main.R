...
test_that("check bin_cumulative has proper args and returns correct results", {
  ...
  expect_equal(head(bin_distribution(3, .3)$probability), c(0.512, 0.384, 0.096, 0.008))
